...
import tr.nttdata.bootcamp.service.impl.DefaultNttbootcampService;
 ...
 */
@IntegrationTest
public class DefaultNttbootcampServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "nttbootcampPlatformLogo";

		// when
		final String logoUrl = nttbootcampService.getHybrisLogoUrl(logoCode);
