...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/nttstorefront/electronics/en",
						"https://electronics.local:9002/nttstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/nttstorefront/electronics/en",
						"https://electronics.local:9002/nttstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/nttstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/nttstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/nttstorefront/electronics/en",
						"https://electronics.local:9002/nttstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/nttstorefront",
						"https://electronics.local:9002/nttstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/nttstorefront",
						"https://electronics.local:9002/nttstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/nttstorefront/electronics/en",
						"https://electronics.local:9002/nttstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
