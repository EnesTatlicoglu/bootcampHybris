 ...
 */
package tr.nttdata.bootcamp.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(NttFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(NttFulfilmentProcessConstants.PARENT_PROCESS);
