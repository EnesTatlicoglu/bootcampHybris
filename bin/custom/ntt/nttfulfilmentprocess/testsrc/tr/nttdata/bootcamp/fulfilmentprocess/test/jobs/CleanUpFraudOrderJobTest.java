 ...
 */
package tr.nttdata.bootcamp.fulfilmentprocess.test.jobs;
...
import tr.nttdata.bootcamp.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = NttFulfilmentProcessConstants.ORDER_PROCESS_NAME;
