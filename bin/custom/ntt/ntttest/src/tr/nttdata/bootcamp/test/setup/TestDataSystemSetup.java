 ...
 */
package tr.nttdata.bootcamp.test.setup;
...
import tr.nttdata.bootcamp.test.constants.NttTestConstants;
import tr.nttdata.bootcamp.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = NttTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/ntttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/ntttest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/ntttest/import/cstickets.impex");
			...
			importImpexFile(context, "/ntttest/import/csquotes.impex");
		}
	}
}
