 ...
 */
package tr.nttdata.bootcamp.core.constants;

/**
 * Global class for all NttCore constants. You can add global constants for your extension into this class.
 */
public final class NttCoreConstants extends GeneratedNttCoreConstants
{
	public static final String EXTENSIONNAME = "nttcore";


	private NttCoreConstants()
	{
		//empty
	}
